...
const DrawerContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Content> & { fullScreen?: boolean }
>(({ className, children, fullScreen, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        fullScreen
          ? "fixed inset-0 z-50 flex h-[100dvh] max-h-[100dvh] w-full flex-col rounded-none border-0 bg-background"
