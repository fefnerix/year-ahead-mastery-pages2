      ...
      <main className="px-5 space-y-5">
        ...
        <Dialog open={scheduleOpen} onOpenChange={setScheduleOpen}>
          <DialogContent className="max-w-[95vw] max-h-[95vh] p-2 bg-background">
            {week.schedule_image_url && (
              <img src={week.schedule_image_url} alt="Cronograma" className="w-full h-full object-contain" />
            )}
          </DialogContent>
        </Dialog>
            ...
            {days.map((day) => {
              ...
              return (
                <button
                  ...
                  } ${!day.is_unlocked ? "opacity-50" : "hover:border-primary/30"}`}
                >
